...
Write-Host "       [+] "$ComplianceName "---" $CurrentValue -ForegroundColor Green 
}
  else {
$ContentHTML	= "$ContentHTML <td class='false'>Non Compliance</td>"
Write-Host "       [-] "$ComplianceName "---" $CurrentValue -ForegroundColor Red
  }
...
$NetAccountsOut = net accounts 
$NetAccountsOut -replace "á", "a" -replace "é", "e" -replace "í­", "i" -replace "ó", "o" -replace "ú", "u" -replace "ñ", "n" -replace "¢", "o"  -replace "¡", "i" -replace "¤", "n" -replace "m x", "max" > $auditFileNetAccount
#$NetAccountsOut =$NetAccountsOut -replace "¢", "o" 
#Write-Host $NetAccountsOut
#$NetAccountsOut > $auditFileNetAccount
...
$traitement		= Get-Content $auditFileNetAccount |Select-String -pattern '(DurÃ©e du verrouillage)|(Lockout duration)|(Duracion de bloqueo)'
$CurrentValue	= $traitement 
$traitement 	= $traitement  -replace "[^0-9]" , ''
...
$traitement		= Get-Content $auditFileNetAccount |Select-String -pattern '(Seuil de verrouillage)|(Lockout threshold)|(Umbral de bloqueo)'
$CurrentValue	= $traitement 
$traitement 	= $traitement  -replace "[^0-9]" , ''
...
$traitement		= Get-Content $auditFileNetAccount |Select-String -pattern "(FenÃªtre d'observation du verrouillage)|(Lockout observation window)|(Ventana de obs. de bloqueo)"
$CurrentValue	= $traitement 
$traitement 	= $traitement  -replace "[^0-9]" , ''
$ComplianceOrNot	= ($traitement  -ge "15") 
$ComplianceHTML += ContentHTML $ComplianceIndex $ComplianceName $CurrentValue $ComplianceOrNot
...
$traitement = Reverse-SID $chaineSID
$CurrentValue	= $traitement 
$ComplianceOrNot	= (($traitement  -match "Administrators")-and ($traitement  -match "LOCAL SERVICE") -and ($traitement  -match "NETWORK SERVICE")) -or (($traitement  -match "Administradores")-and ($traitement  -match "LOCAL SERVICE") -and ($traitement  -match "NETWORK SERVICE"))
$ComplianceHTML += ContentHTML $ComplianceIndex $ComplianceName $CurrentValue $ComplianceOrNot
...
$traitement = Reverse-SID $chaineSID
$CurrentValue	= $traitement 
$ComplianceOrNot	= (($traitement  -match "Administrators") -and ($traitement  -notmatch "Guest")  -and ($traitement  -notmatch "Everyone")) -or (($traitement  -match "Administradores") -and ($traitement  -notmatch "Guest")  -and ($traitement  -notmatch "Everyone"))
$ComplianceHTML += ContentHTML $ComplianceIndex $ComplianceName $CurrentValue $ComplianceOrNot
...
$traitement = Reverse-SID $chaineSID
$CurrentValue	= $traitement 
$ComplianceOrNot	= (($traitement  -match "Administrators") -and ($traitement  -match "Remote Desktop Users") -and ($traitement  -notmatch "Guest") )  -or (($traitement  -match "Administradores") -and ($traitement  -match "Usuarios de escritorio remoto") -and ($traitement  -notmatch "Guest") )
$ComplianceHTML += ContentHTML $ComplianceIndex $ComplianceName $CurrentValue $ComplianceOrNot
...
$traitement = Reverse-SID $chaineSID
$CurrentValue	= $traitement 
$ComplianceOrNot	= ((($traitement  -match "Administrators") -or ($traitement  -match "Administradores")) -and ($traitement.Length -lt 30)) 
$ComplianceHTML += ContentHTML $ComplianceIndex $ComplianceName $CurrentValue $ComplianceOrNot
...
$traitement = Reverse-SID $chaineSID
$CurrentValue	= $traitement 
$ComplianceOrNot	= (($traitement  -match "Administrators") -and ($traitement  -match "LOCAL SERVICE") -and ($traitement  -notmatch "autotimesvc")  -and ($traitement  -notmatch "Everyone")) -or (($traitement  -match "Administradores") -and ($traitement  -match "LOCAL SERVICE") -and ($traitement  -notmatch "autotimesvc")  -and ($traitement  -notmatch "Everyone"))
$ComplianceHTML += ContentHTML $ComplianceIndex $ComplianceName $CurrentValue $ComplianceOrNot
...
$traitement = Reverse-SID $chaineSID
$CurrentValue	= $traitement 
$ComplianceOrNot	= (($traitement  -match "Administrators") -and ($traitement  -match "LOCAL SERVICE") -and ($traitement  -notmatch "Users") -and ($traitement  -notmatch "Guest")  -and ($traitement  -notmatch "Everyone")) -or (($traitement  -match "Administradores") -and ($traitement  -match "LOCAL SERVICE") -and ($traitement  -notmatch "Usuarios") -and ($traitement  -notmatch "Guest")  -and ($traitement  -notmatch "Everyone"))
$ComplianceHTML += ContentHTML $ComplianceIndex $ComplianceName $CurrentValue $ComplianceOrNot
...
$traitement = Reverse-SID $chaineSID
$CurrentValue	= $traitement 
$ComplianceOrNot	= (($traitement  -match "Administrators") -and ($traitement  -match "LOCAL SERVICE")  -and ($traitement  -match "SERVICE")) -or (($traitement  -match "Administradores") -and ($traitement  -match "LOCAL SERVICE")  -and ($traitement  -match "SERVICE")) 
$ComplianceHTML += ContentHTML $ComplianceIndex $ComplianceName $CurrentValue $ComplianceOrNot
...
$traitement = Reverse-SID $chaineSID
$CurrentValue	= $traitement 
$ComplianceOrNot	= (($traitement  -match "Guest") -and ($traitement  -match "Local account")) -or (($traitement  -match "Invitado") -and ($traitement  -match "Local account"))
$ComplianceHTML += ContentHTML $ComplianceIndex $ComplianceName $CurrentValue $ComplianceOrNot
...
$traitement = Reverse-SID $chaineSID
$CurrentValue	= $traitement 
$ComplianceOrNot	= (($traitement  -match "Guest")) -or (($traitement  -match "Invitado"))
$ComplianceHTML += ContentHTML $ComplianceIndex $ComplianceName $CurrentValue $ComplianceOrNot
...
$traitement = Reverse-SID $chaineSID
$CurrentValue	= $traitement 
$ComplianceOrNot	= (($traitement  -match "Administrators") -and ($traitement  -match "LOCAL SERVICE")  -and ($traitement  -match "NETWORK SERVICE")-and ($traitement  -match "NT AUTHORITY\\SERVICE"))  -or (($traitement  -match "Administradores") -and ($traitement  -match "LOCAL SERVICE")  -and ($traitement  -match "NETWORK SERVICE")-and ($traitement  -match "NT AUTHORITY\\SERVICE"))
$ComplianceHTML += ContentHTML $ComplianceIndex $ComplianceName $CurrentValue $ComplianceOrNot
...
$traitement = Reverse-SID $chaineSID
$CurrentValue	= $traitement 
$ComplianceOrNot	= (($traitement  -match "Administrators") -and ($traitement  -match "Window Manager\\Window Manager Group")) -or (($traitement  -match "Administradores") -and ($traitement  -match "Window Manager\\Window Manager Group")) 
$ComplianceHTML += ContentHTML $ComplianceIndex $ComplianceName $CurrentValue $ComplianceOrNot
...
$traitement = Reverse-SID $chaineSID
$CurrentValue	= $traitement 
$ComplianceOrNot	= (($traitement  -match "Administrators") -and ($traitement  -match "NT SERVICE\\WdiServiceHost")) -or (($traitement  -match "Administradores") -and ($traitement  -match "NT SERVICE\\WdiServiceHost"))
$ComplianceHTML += ContentHTML $ComplianceIndex $ComplianceName $CurrentValue $ComplianceOrNot
...
$CurrentValue	= $traitement 
$ComplianceOrNot	= (($traitement  -notmatch "Administrator"))  -or (($traitement  -notmatch "Administrador"))
$ComplianceHTML += ContentHTML $ComplianceIndex $ComplianceName $CurrentValue $ComplianceOrNot
...
$CurrentValue	= $traitement 
$ComplianceOrNot	= (($traitement  -notmatch "Guest")) -or (($traitement  -notmatch "Invitado"))
$ComplianceHTML += ContentHTML $ComplianceIndex $ComplianceName $CurrentValue $ComplianceOrNot
